...
if __name__ == "__main__":
    ...
    for rootElement in concatenatedBalancesNoncesTreeRoot:
        
        concatenatedBalancesNoncesTreeRootHex.append(hex(int(rootElement))) 
    ...
    with open("sampleZokOutput.json", "w") as outfile:
        outfile.write(obj)
